...
class DeepPhysEnhanced(nn.Module):
    ...
    def forward(self, diff_input, raw_input, posgreen_input):
        ...
        # POS + Green branch
        b1 = torch.tanh(self.posgreen_conv1(posgreen_input))
        b2 = torch.tanh(self.posgreen_conv2(b1))
        b3 = torch.tanh(self.posgreen_conv3(b2))
        b4 = torch.tanh(self.posgreen_conv4(b3))
        ...
        d10 = torch.tanh(self.final_dense_1(merged_flat))
